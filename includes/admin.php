...
class ScribbleMaps_List_Table extends Scribble_WP_List_Table {
    ...
    function column_default($item, $column_name) {
        ...
        switch ($column_name) {
            ...
            case 'shortcode':
                return '[scribblemaps mapid="' . $item["mapid"] . '" width="450" height="300"]';
            default:
...
function my_enqueue($hook) {
    ...
    wp_enqueue_script('scribble-map-layers', SCRIBBLEMAPS_URL . 'js/layers.js');
...
function scribblemaps_new() {
	...
	<div id="mapTypes">
            <select>
                <option value="base">Google</option>
                <option value="mb">MapBox</option>
                <option value="sm">White Board</option>
                <option value="osm">Open Street Map</option>
                <option value="esri">ESRI</option>
                <option value="astral">Night Sky</option>
            </select>
        </div>        <div id="popup">
		...
		<p>If you like our plugin please rate it <a href="https://wordpress.org/plugins/scribble-maps" target="_blank">here</a> Thanks!</p>
			</div>
